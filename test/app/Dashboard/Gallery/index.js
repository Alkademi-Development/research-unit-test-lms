...
Waktu Event Load Selesai (loadEventEnd): (${performanceTiming.loadEventEnd - navigationStart}) milliseconds ( ${((performanceTiming.loadEventEnd - navigationStart) / 1000)} seconds )
    ...
    BROWSERS.forEach(browser => {
        ...
        users.forEach(userData => {
            ...
            switch (user.kind) {
                case 0:
                    it.skip(`SUPER ADMIN - Create a Gallery from browser ${browser}`, async () => {
                        ...
                        try {
                            ...
                            // Aksi klik menu 'User'
                            await driver.executeScript(`return document.querySelector("ul.navbar-nav li a i.ri-gallery-line").click()`)

                            // Aksi sleep
                            await driver.sleep(3000)

                            // Aksi menekan tombol '+ Gallery'
                            await driver.executeScript(`return document.querySelector(".main-content a.btn-primary .ri-add-line").click()`)

                            // Aksi Sleep
                            await driver.sleep(10000)

                            // Aksi mengisi form gallery
                            /** Dummy Data **/
                            ...
                            /** Input description */
                            await driver.findElement(By.id("Deskripsi *")).sendKeys(description);
                            await driver.sleep(2000);
                            ...
                            let isAllFilled = await Promise.all([
                                ...
                                await driver.findElement(By.id("Deskripsi *")).getAttribute("value"),
                            ...
                            customMessages = [
                                await alertWarning == null && isAllFilled ? 'Successfully created a new gallery ✅' : 'Failed to create a new gallery ❌'
                            ]
                    ...
                    it(`SUPER ADMIN - Open a Gallery from browser ${browser}`, async () => {
                        ...
                        try {
                            ...
                            // Aksi menekan tombol 'Lihat Gallery' details
                            let gallerySlug = await driver.executeScript(`return document.querySelector("table tbody tr td[aria-colindex='3']").innerText.toLowerCase().replace(/ /g, '-').replaceAll('.', '')`)
                            await driver.executeScript(`return document.querySelector("table tbody tr td button.btn-primary").click()`);
                            ...
                            currentUrl = await currentUrl.replace(/%(\d+)?/g, '-').replaceAll('.', '');
                            let cardContent = await driver.executeScript(`return document.querySelector(".main-content .card")`);
                            customMessages = [
                                await currentUrl.includes(await gallerySlug) && await cardContent != null ? '- Successfully read the gallery ✅' : '- Failed to read the gallery ❌'
                            ]
                            expect(await currentUrl.includes(await gallerySlug) && await cardContent != null).to.be.true
                    ...
                    it.skip(`SUPER ADMIN - Edit the Gallery from browser ${browser}`, async () => {
                        ...
                        try {
                            ...
                            // Aksi memilih salah satu Gallery untuk di edit
                            ...
                            await driver.sleep(2000);
                            /** Input description */
                            await driver.findElement(By.id("Deskripsi *")).clear();
                            await driver.findElement(By.id("Deskripsi *")).sendKeys(description);
                            await driver.sleep(2000);
                            /** Aksi upload file thumbnail */
                            let inputFileElements = await driver.wait(until.elementsLocated(By.css("input[type=file].dz-hidden-input")));
                            ...
                            // Expect results and add custom message for addtional description
                            customMessages = [
                                await alertWarning == null && isAllFilled ? 'Successfully created a new gallery Admin ✅' : 'Failed to create a new gallery ❌'
                            ]
                            expect(await alertWarning).to.be.null
                            expect(isAllFilled).to.be.true
                    ...
                    it.skip(`SUPER ADMIN - Check the pagination of Table List Gallery from browser ${browser}`, async () => {
                    ...
                    it.skip(`SUPER ADMIN - Check the next page of pagination of Table List Gallery from browser ${browser}`, async () => {
                    ...
                    it.skip(`SUPER ADMIN - Check the last page number of pagination of Table List Gallery from browser ${browser}`, async () => {
                    ...
                    it.skip(`SUPER ADMIN - Choose a page number of pagination of Table List Gallery from browser ${browser}`, async () => {
                    ...
                    it.skip(`SUPER ADMIN - Check the previous page of pagination of Table List Gallery from browser ${browser}`, async () => {
                    ...
                    it.skip(`SUPER ADMIN - Check the first page of pagination of Table List Gallery from browser ${browser}`, async () => {
                    ...
                    it.skip(`SUPER ADMIN - Delete the Gallery from browser ${browser}`, async () => {
                        ...
                        try {
                            ...
                            customMessages = [
                                await tableBody != await newTableBody ? '- Successfully deleted the Gallery ✅' : '- Failed to delete the Gallery ❌'
                            ];
                ...
                case 1:
                    it(`ADMIN - Create a Gallery from browser ${browser}`, async () => {
                    ...
                    it(`ADMIN - Open a Gallery from browser ${browser}`, async () => {
                    ...
                    it(`ADMIN - Edit the Gallery from browser ${browser}`, async () => {
                    ...
                    it(`ADMIN - Check the pagination of Table List Gallery from browser ${browser}`, async () => {
                    ...
                    it(`ADMIN - Check the next page of pagination of Table List Gallery from browser ${browser}`, async () => {
                    ...
                    it(`ADMIN - Check the last page number of pagination of Table List Gallery from browser ${browser}`, async () => {
                    ...
                    it(`ADMIN - Choose a page number of pagination of Table List Gallery from browser ${browser}`, async () => {
                    ...
                    it(`ADMIN - Check the previous page of pagination of Table List Gallery from browser ${browser}`, async () => {
                    ...
                    it(`ADMIN - Check the first page of pagination of Table List Gallery from browser ${browser}`, async () => {
                    ...
                    it(`ADMIN - Delete the Gallery from browser ${browser}`, async () => {
                ...
                case 6:
                    it(`CONTENT WRITER - Create a Gallery from browser ${browser}`, async () => {
                    ...
                    it(`CONTENT WRITER - Open a Gallery from browser ${browser}`, async () => {
                    ...
                    it(`CONTENT WRITER - Edit the Gallery from browser ${browser}`, async () => {
                    ...
                    it(`CONTENT WRITER - Check the pagination of Table List Gallery from browser ${browser}`, async () => {
                    ...
                    it(`CONTENT WRITER - Check the next page of pagination of Table List Gallery from browser ${browser}`, async () => {
                    ...
                    it(`CONTENT WRITER - Check the last page number of pagination of Table List Gallery from browser ${browser}`, async () => {
                    ...
                    it(`CONTENT WRITER - Choose a page number of pagination of Table List Gallery from browser ${browser}`, async () => {
                    ...
                    it(`CONTENT WRITER - Check the previous page of pagination of Table List Gallery from browser ${browser}`, async () => {
                    ...
                    it(`CONTENT WRITER - Check the first page of pagination of Table List Gallery from browser ${browser}`, async () => {
                    ...
                    it(`CONTENT WRITER - Delete the Gallery from browser ${browser}`, async () => {
