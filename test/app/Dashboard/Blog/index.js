...
Waktu Event Load Selesai (loadEventEnd): (${performanceTiming.loadEventEnd - navigationStart}) milliseconds ( ${((performanceTiming.loadEventEnd - navigationStart) / 1000)} seconds )
    ...
    BROWSERS.forEach(browser => {
        ...
        users.forEach(userData => {
            ...
            switch (user.kind) {
                case 0:
                    it.skip(`SUPER ADMIN - Create a Blog from browser ${browser}`, async () => {
                        ...
                        try {
                            ...
                            // Aksi klik menu 'User'
                            await driver.executeScript(`return document.querySelector("ul.navbar-nav li a i.ri-article-line").click()`)

                            // Aksi sleep
                            await driver.sleep(3000)

                            // Aksi menekan tombol '+ Blog'
                            await driver.executeScript(`return document.querySelector(".main-content a.btn-primary .ri-add-line").click()`)

                            // Aksi Sleep
                            await driver.sleep(3000)

                            // Aksi mengisi form blog
                            /** Dummy Data **/
                            ...
                            customMessages = [
                                await alertWarning == null && isAllFilled ? 'Successfully created a new article ✅' : 'Failed to create a new article ❌'
                            ]
                    ...
                    it(`SUPER ADMIN - Open a Blog from browser ${browser}`, async () => {
                        ...
                        try {
                            ...
                            // Aksi menekan tombol 'Lihat Blog' details
                            let blogSlug = await driver.executeScript(`return document.querySelector("table tbody tr td[aria-colindex='2']").innerText.toLowerCase().replace(/ /g, '-').replaceAll('.', '')`)
                            ...
                            customMessages = [
                                await currentUrl.includes(await blogSlug) && await cardContent != null ? '- Successfully read the article ✅' : '- Failed to read the article ❌'
                            ]
                            expect(await currentUrl.includes(await blogSlug) && await cardContent != null).to.be.true
                    ...
                    it.skip(`SUPER ADMIN - Edit the Blog from browser ${browser}`, async () => {
                        ...
                        try {
                            ...
                            // Expect results and add custom message for addtional description
                            customMessages = [
                                await alertWarning == null && isAllFilled ? 'Successfully created a new article Admin ✅' : 'Failed to create a new article ❌'
                            ]
                            expect(await alertWarning).to.be.null
                            expect(isAllFilled).to.be.true
                    ...
                    it.skip(`SUPER ADMIN - Check the pagination of Table List Blog from browser ${browser}`, async () => {
                    ...
                    it.skip(`SUPER ADMIN - Check the next page of pagination of Table List Blog from browser ${browser}`, async () => {
                    ...
                    it.skip(`SUPER ADMIN - Check the last page number of pagination of Table List Blog from browser ${browser}`, async () => {
                    ...
                    it.skip(`SUPER ADMIN - Choose a page number of pagination of Table List Blog from browser ${browser}`, async () => {
                    ...
                    it.skip(`SUPER ADMIN - Check the previous page of pagination of Table List Blog from browser ${browser}`, async () => {
                    ...
                    it.skip(`SUPER ADMIN - Check the first page of pagination of Table List Blog from browser ${browser}`, async () => {
                    ...
                    it.skip(`SUPER ADMIN - Delete the Blog from browser ${browser}`, async () => {
                ...
                case 1:
                    it.skip(`ADMIN - Create a Blog from browser ${browser}`, async () => {
                    ...
                    it(`ADMIN - Open a Blog from browser ${browser}`, async () => {
                    ...
                    it.skip(`ADMIN - Edit the Blog from browser ${browser}`, async () => {
                    ...
                    it.skip(`ADMIN - Check the pagination of Table List Blog from browser ${browser}`, async () => {
                    ...
                    it.skip(`ADMIN - Check the next page of pagination of Table List Blog from browser ${browser}`, async () => {
                    ...
                    it.skip(`ADMIN - Check the last page number of pagination of Table List Blog from browser ${browser}`, async () => {
                    ...
                    it.skip(`ADMIN - Choose a page number of pagination of Table List Blog from browser ${browser}`, async () => {
                    ...
                    it.skip(`ADMIN - Check the previous page of pagination of Table List Blog from browser ${browser}`, async () => {
                    ...
                    it.skip(`ADMIN - Check the first page of pagination of Table List Blog from browser ${browser}`, async () => {
                    ...
                    it.skip(`ADMIN - Delete the Blog from browser ${browser}`, async () => {
                ...
                case 6:
                    it.skip(`CONTENT WRITER - Create a Blog from browser ${browser}`, async () => {
                    ...
                    it(`CONTENT WRITER - Open a Blog from browser ${browser}`, async () => {
                    ...
                    it.skip(`CONTENT WRITER - Edit the Blog from browser ${browser}`, async () => {
                    ...
                    it.skip(`CONTENT WRITER - Check the pagination of Table List Blog from browser ${browser}`, async () => {
                    ...
                    it.skip(`CONTENT WRITER - Check the next page of pagination of Table List Blog from browser ${browser}`, async () => {
                    ...
                    it.skip(`CONTENT WRITER - Check the last page number of pagination of Table List Blog from browser ${browser}`, async () => {
                    ...
                    it.skip(`CONTENT WRITER - Choose a page number of pagination of Table List Blog from browser ${browser}`, async () => {
                    ...
                    it.skip(`CONTENT WRITER - Check the previous page of pagination of Table List Blog from browser ${browser}`, async () => {
                    ...
                    it.skip(`CONTENT WRITER - Check the first page of pagination of Table List Blog from browser ${browser}`, async () => {
                    ...
                    it.skip(`CONTENT WRITER - Delete the Blog from browser ${browser}`, async () => {
